...
if ( -d 'E:\\YASH\\login Database\\xamp\\minicpan' ) {
  ...
  unless ( $@ ) {
    if ( LWP::Online::online() ) {
      push @urllist, q[file:///E:/YASH/login Database/xamp/minicpan/];
    } else {
      unshift @urllist, q[file:///E:/YASH/login Database/xamp/minicpan/];
    }
  }
}
...
$CPAN::Config = {
  ...
  auto_commit                   => q[1],
  build_cache                   => q[50],
  build_dir                     => q[E:\\YASH\\login Database\\xamp\\cpan\\build],
  build_dir_reuse               => q[0],
  ...
  cpan_home                     => q[E:\\YASH\\login Database\\xamp\\cpan],
  curl                          => q[],
  ...
  halt_on_failure               => q[1],
  histfile                      => q[E:\\YASH\\login Database\\xamp\\cpan\\histfile],
  histsize                      => q[1000],
  http_proxy                    => q[],
  inactivity_timeout            => q[0],
  index_expire                  => q[1],
  inhibit_startup_message       => q[0],
  keep_source_where             => q[E:\\YASH\\login Database\\xamp\\cpan\\sources],
  load_module_verbosity         => q[none],
  lynx                          => q[],
  make                          => q[E:\\YASH\\login Database\\xamp\\c\\bin\\gmake.exe],
  make_arg                      => q[],
  make_install_arg              => q[UNINST=1],
  make_install_make_command     => q[E:\\YASH\\login Database\\xamp\\c\\bin\\gmake.exe],
  makepl_arg                    => q[],
  mbuild_arg                    => q[],
  ...
  patch                         => q[E:\\YASH\\login Database\\xamp\\c\\bin\\patch.exe],
  perl5lib_verbosity            => q[none],
  prefer_external_tar           => q[0],
  prefer_installer              => q[MB],
  prefs_dir                     => q[E:\\YASH\\login Database\\xamp\\cpan\\prefs],
